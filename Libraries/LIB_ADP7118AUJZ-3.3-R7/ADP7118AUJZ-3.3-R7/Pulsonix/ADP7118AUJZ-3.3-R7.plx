...
(library Library_1
	...
	(symbolDef "ADP7118AUJZ-3.3-R7" (originalName "ADP7118AUJZ-3.3-R7")
	...
	(compDef "ADP7118AUJZ-3.3-R7" (originalName "ADP7118AUJZ-3.3-R7") (compHeader (numPins 5) (numParts 1) (refDesPrefix IC)
		)
		...
		(compPin "4" (pinName "SENSE/ADJ") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "5" (pinName "VOUT") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "ADP7118AUJZ-3.3-R7"))
		...
		(attr "Mouser Part Number" "584-ADP7118AUJZ3.3R7")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Analog-Devices/ADP7118AUJZ-3.3-R7?qs=hpwIUhX6lWxSxNRE9lKdtQ%3D%3D")
		(attr "Manufacturer_Name" "Analog Devices")
		(attr "Manufacturer_Part_Number" "ADP7118AUJZ-3.3-R7")
		(attr "Description" "20 V, 200 mA, Low Noise, CMOS LDO Linear Regulator")
		(attr "<Hyperlink>" "https://www.analog.com/ADP7118/datasheet")
		(attr "<Component Height>" "1")
		(attr "<STEP Filename>" "ADP7118AUJZ-3.3-R7.stp")
